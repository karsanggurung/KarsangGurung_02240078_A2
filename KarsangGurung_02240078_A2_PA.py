...
while True:
    ...
    if choice == 1:
        ...
        Score2 = 0
        while(True):
            user_choice = str(input("enter your choice [Rock, Paper,Scissor, Quit] : ")).lower()
            ...
            elif (user_choice[0]=="p" and computer=="rock") or (user_choice[0]=="s" and computer=="paper") or (user_choice[0]=="r" and computer=="scissor"):
               print("you win")
               Score2 = Score2+5
        ...
        while True:
            ...
            if option == 1:
                ...
                if feature==1:
                    for i in pokedex_binder(least_pokedex, Highest_pokedex):
